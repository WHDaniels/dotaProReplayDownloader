...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.amountLabel.setGeometry(QtCore.QRect(40, 90, 221, 16))
        ...
        self.downloadButton.setGeometry(QtCore.QRect(280, 130, 121, 23))
