...
Summary
  This program takes data in the form of match id's of high mmr players from dota2protracker.com
  for the hero the user has specified. The replays of the specific match id's are then grabbed from  opendota.com
  ...
  This program makes only one visit to dota2protracker.com per download request, regardless 
  ...
  replays personally. The same can be said for visits to opendota.com. Dota Pro Replay Downloader is just a tool 
